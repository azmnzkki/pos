            ...
            <div class="main-content">
                <section class="section">
                    ...
                    <div class="section-body">
                        <div class="row">
                            <div class="col-12 col-md-6 col-lg-6 p-2 d-flex justify-content-center align-items-center row">
                                <div class="row g-0">
                                    <div class="p-2 rounded overflow-hidden m-0 col-6 h-fit position-relative">
                                        ...
                                        <img alt="image" src="../assets/img/ayam-bakar.jpeg" class="img-fluid">
                                        <h5 class="m-0">Ayam Bakar</h5>
                                        <p class="m-0">11k</p>
                                    </div>
                                    <div class="p-2 rounded overflow-hidden m-0 col-6 h-fit position-relative">
                                        <span class="position-absolute top-0 mt-1 ml-1 start-100 translate-middle badge rounded-pill  bg-primary text-white">+1</span>
